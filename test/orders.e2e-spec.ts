...
test('filter by order id', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'Filtar Resultados' }).click()
...
test('filter by order customer name', async ({ page }) => {
  ...
  await page.getByPlaceholder('Nome do cliente').fill('Customer 40')
  await page.getByRole('button', { name: 'Filtar Resultados' }).click()

  expect(page.getByRole('cell', { name: 'Customer 40' })).toBeVisible()
